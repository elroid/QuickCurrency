...
class DateTimeSerializerTest : KoinTest {
    ...
    @Test
    fun deserialize_givenMultiZoneFormat_returnsExpected() {
        val dateTimeString = "\"2024-05-28 00:00:00+00+00\""
        val expectedDateTime = OffsetDateTime.of(2024, 5, 28, 0, 0, 0, 0, ZoneOffset.UTC)
        val deserializedDateTime = json.decodeFromString<OffsetDateTime>(dateTimeString)
